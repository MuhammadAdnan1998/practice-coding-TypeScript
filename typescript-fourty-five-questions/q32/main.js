...
var current_users = ['John', 'Alice', 'admin', 'Bob', 'Emma']; // Replace with your current usernames
var new_users = ['Alice', 'Eric', 'Sara', 'Admin', 'Olivia']; // Replace with your new usernames
for (var i = 0; i < new_users.length; i++) {
    var newUser = new_users[i];
    var lowerNewUser = newUser.toLowerCase(); // Convert to lowercase for case-insensitive comparison
